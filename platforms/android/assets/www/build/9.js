...
var ContentPage = /** @class */ (function () {
    ...
    ContentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-content',template:/*ion-inline-start:"/Users/dianasilva/Documents/Sebastian/Testa/App/Layout/src/pages/content/content.html"*/'<!--\n  Generated template for the ContentPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n</ion-header>\n\n\n<ion-content padding>\n  <div>\n    <ion-title padding>\n      <h2 style="color:white">Menu principal</h2>\n    </ion-title>\n  	<button ion-button class="ropciones" margin-vertical (click)="categorias()">Categorias</button>\n    <br>\n  	<button ion-button class="ropciones" margin-vertical (click)="figuraFondo()">Figura Fondo</button>\n    <br>\n  	<button ion-button class="ropciones" margin-vertical (click)="identificacionDeContextosOSituaciones()">Identificacion De Contextos <br>O Situaciones</button>\n    <br>\n  	<button ion-button class="ropciones" margin-vertical (click)="memoriaDeSonidos()">Memoria <br>De Sonidos</button>\n    <br>\n  	<button ion-button class="ropciones" margin-vertical (click)="memoriaDeSonidosEnSecuencia()">Memoria De <br>Sonidos En Secuencia</button>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/dianasilva/Documents/Sebastian/Testa/App/Layout/src/pages/content/content.html"*/,
        }),
